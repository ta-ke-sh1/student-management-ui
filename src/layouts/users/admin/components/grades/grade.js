...
export default function GradeAdmin(props) {
    ...
    const { data } = useFetchRequests(
        process.env.REACT_APP_HOST_URL + "/user/grade"
    );
    ...
    const fetchRows = () => {
        try {
            axios
                .get(process.env.REACT_APP_HOST_URL + "/user/grade")
                .then((res) => {
                    if (res.data.status) {
    ...
    const handleDelete = (index) => {
        try {
            ...
            setDialogContent(
                "This grade will be deleted, are you sure? This change cannot be undone"
            );
            setOpen(true);
            setSelected(index);
            console.log(index);
    ...
    const handleDeleteRequest = () => {
        try {
            ...
            axios
                .delete(
                    process.env.REACT_APP_HOST_URL + "/campus/grade?q=" + query
                )
                .then((res) => {
                    console.log(res);
                    setOpen(false);
